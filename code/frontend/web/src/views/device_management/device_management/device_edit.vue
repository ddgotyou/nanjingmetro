        ...
        <el-row>
          ...
          <el-col span="12">
            <el-form-item label="状态">
              <el-input id="status" v-model="formData.status" name="status"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
    ...
    list() {
      ...
      .then( res => {
        ...
        that.formData={
          ...
          deviceStatus: res.deviceStatusVO[description],
          deviceDescription: res.deviceDescription,
          purchaseDate:res.purchaseDate,
          deviceClassroom: res.deviceClassroom,
          chargepeople:res.chargepeople,
          afterSale:res.afterSale,
          afterSaleNumber:res.afterSaleNumber,
        };
      });
    },
    getRepairSelection() {
