<template>
  <div class="app-container">
          ...
          <el-form :label-position="right" inline="true" model="basicinfo" ref="basicinfo" class="form" label-width="100px">
              ...
              <el-form-item label="用途" prop="equname" >
                ...
                <el-form-item label="负责人">
                  <el-select v-model="basicinfo.attributes" multiple placeholder="请选择" style="width:90%;">
          ...
          <el-form inline="true" model="repareinfo" ref="repareinfo" label-width="100px" class="form">
		  				<el-form-item label="周期" prop="taskmajor" >
			  				<el-select v-model="repareinfo.taskmajor" >
							    <el-option label="一号" value="1"></el-option>
                  <el-option label="二号" value="2"></el-option>
						  	</el-select>
						  </el-form-item>
              <el-form-item label="维保时间" prop="task">
			  				<el-select v-model="repareinfo.task" >
							    <el-option label="一号" value="1"></el-option>
                  <el-option label="二号" value="2"></el-option>
						  	</el-select>
						  </el-form-item>
              ...
              <el-form-item label="维护人员" prop="classify">
			  				<el-select v-model="repareinfo.classify"  >
							    <el-option label="一号" value="1"></el-option>
                  <el-option label="二号" value="2"></el-option>
						  	</el-select>
						  </el-form-item>
